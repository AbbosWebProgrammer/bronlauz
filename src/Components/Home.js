...
import promotion from "../images/bronlauz/promotion.png";
                                            ...
                                            <div className="first-part align-items-center">
                                                <Dropdown className='align-items-center '>
                                                    ...
                                                    <Dropdown.Menu variant="white">
                                                        <Dropdown.Item as={Link} ><Link to={"/wishlists"} className="align-items-center d-flex dropdownbuttoncss">Список желаний</Link></Dropdown.Item>
                                                        <Dropdown.Item as={Link}><Link to={"/myorders"} className="dropdownbuttoncss">Мои заказы</Link></Dropdown.Item>
                                        ...
                                        <Col className='mb-4'  xs={12} sm={6} md={4} lg={3} >
                                            <div className="countryhousemenu ">
                                                <div className="carousel-main ">                           
                                                    ...
                                                    <img className='countryhouse_promotion' src={promotion} />
                                                    :
                                                    ''
                                                    }
