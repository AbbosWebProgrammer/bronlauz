...
const Home = (props) =>{
    ...
    return (<>
      <YMInitializer  accounts={[90594448]} options={{webvisor: true}} version="2"/>
            ...
            <>
            {yandexmap?
            <button class="_15e9w0f" onClick={(e) =>{ setYandexmap(!yandexmap)}} >
                <span class="_7u66d2">
                    <span class="_r16tng">Показать список</span>
            ...
            <button class="_15e9w0f" onClick={(e) =>{ setYandexmap(!yandexmap)}}>
                <span class="_7u66d2">
                    <span class="_r16tng">Показать карту</span>
            ...
            {yandexmap? <div className='row_css_home_page_map'>
                            <YMaps  >
                                        ...
                                        properties={{
                                            ...
                                            <a href="/countryhouse/${item.id} " target="_blank" className="text-decoration-none text-black">
                                                <div class="yandex_map_main_page">	
                                                        <div class="yandex_map_main_page_label" for="clubs"><img src=${item.images[0]} alt="image" ></div>
                                                ...
                                                <div class='yandex_map_main_page_title'>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            ${item.alcohol?
                                                                '<img src="/static/media/acohol.d42acc0c.png" class="alcohollogocss" alt="img"/>'
                                                                :
                                                                '<img src="/static/media/notalcahol.a3126875.png" class="alcohollogocss"  alt="img"/>'
                                                                }
                                                                </div>
                                                        </div>
                                                </div>
                                            ...
                                            <Slider dots={true} autoplaySpeed={3000} >
                                                {item.images.map(index => (
                                                    ...
                                                    <div className="ar-16-9">
                                                      ...
                                                      data-bs-toggle="modal" data-bs-target="#exampleModal"   alt={item.name}/> 
